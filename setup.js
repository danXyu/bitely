/**
 * File: bitely/setup.js
 *
 * Description: This setup file allows the system control to manipulate the code in this project. 
 * It will lead to changes that can be permanent, so be careful. Instead of requiring more
 * login methods than necessary, I chose to only allow the user to sign in via google+,
...
if (os.platform() === 'win32') {
  console.log('*************************************************************');
  console.log('Windows platform is unsupported in running this application');
  console.log('*************************************************************');
  process.exit();
}

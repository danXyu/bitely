...
/**
 *  Testing Pearson Kitchen Manager API.
 */


exports.getPearson = function(req, res) {
  var ingredients = ["granulated sugar", "sugar"];
  ingredients = ingredients.join(", ");

  var query = querystring.stringify({'ingredients-all': ingredients});
